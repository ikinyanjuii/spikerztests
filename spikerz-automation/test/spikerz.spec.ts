...
test('Spikerz Social Connect - YouTube', async ({ page }) => {
  ...
  // Step 2: Navigate to Social Connect
  await page.goto('/social-connect/');
  await page.click('text=YouTube');

  // Step 3: Handle Google Login popup
